  ...
  <table class="editinline">
    ...
    if (is_array($files) && count($files) > 0) {
      foreach($files as $file) {
        ...
        echo '<td><span class="asset_thumb">' . $file->thumb_html . '</span></td>';
        ...
        echo '<td class="title_td">' . form_input( array(
        ...
        echo '</td>';
        echo '<td class="medium_thumb" style="display:none">' . $file->thumb_html . '</td>';
...
jQuery(document).ready(function() {
  ...
  jQuery("body").undelegate(".btn_delete", "click")
  ...
  jQuery("body").undelegate(".asset_selector", "click")
  .delegate(".asset_selector", "click", function(){
    var asset_id = jQuery(this).parents("tr.file_row").attr("id").substring(10);
    var asset_preview = jQuery(this).parents("tr.file_row").children(".medium_thumb").html();
    var asset_title = jQuery(this).parents("tr.file_row").children("td.title_td").children("input").val();
