...
function randomWidgetDeleteImage(id)
{
  ...
  jQuery.get(url, function(data){
    ...
    jQuery("#widget-config").load("/hotcms/page/ajax_config_section/" + page_id + "/<?php echo $page_section_id ?>");
...
function random_uploadDone()
{
  ...
  if(data.status == "success") {
    ...
    jQuery('#formRandomInfo').submit();
    jQuery("#widget-config").load("/hotcms/page/ajax_config_section/<?php echo $page_section_id ?>");
  } else {
