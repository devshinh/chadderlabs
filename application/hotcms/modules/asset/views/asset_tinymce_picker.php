...
<!--	<script type="text/javascript" src="/hotcms/asset/js/tinymce/tiny_mce_popup.js"></script>
  ...
  jQuery(document).ready(function(){
    jQuery(".asset_selector").css("border", "3px solid #f0f0ee");
    ...
    document.getElementById("upload_target").onload = uploadDone;
              ...
              document.getElementById( 'submit-image' ).onclick = function(){
                ...
                //var imageID = document.getElementById( 'imagesrc' ).value;

                window.parent.tinyMCE.activeEditor.execCommand( 'mceInsertContent', 0, imageSRC );
                //window.parent.tinyMCEPopup.close(); 
                alert('Image inserted to page.');
            };    
...
<body>
  ...
  <form method="post" id="formHotimg" name="formHotimg" class="configform"  action="#">
    ...
    <div class="mceActionPanel">
      <input type="button" id="submit-image" name="insert" value="Insert" class="red_button_smaller" style="padding: 3px 6px" />
