      ...
      // reload
        ...
        if($st == 1){
            ...
            if(!empty($referral_user_info) && $referral_user_info->id > 0 && $referral_user_info->referal_user_id > 0){
              ...
              account_add_contest_entries($referral_user_info->referal_user_id, 500,'reffer_veri','refer_colleague',$referral_user_info->id,' earned 500 contest entries because their <a href="http://earetailprofessionals.cheddarlabs.com/overview/refer-a-colleague">referral</a> verified themselves!');
