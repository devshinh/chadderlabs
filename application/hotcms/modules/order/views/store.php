...
<div>
  <div class="row">
  <?php
    echo form_label(lang( 'hotcms_retailer' ) . ' ' . lang( 'hotcms_name' ) . ' ' . lang( 'hotcms__colon' ));
    echo $retailer->name;
  ?>
  </div>
  <div class="row">
...
<a href="/hotcms/<?php echo $module_url; ?>/index/<?php echo $index_page_num; ?>" class="red_button"><?php echo lang('hotcms_back') . ' to Retailer List' ?></a>
...
<div class="table">
  <table id="tableCurrent" class="table_sorter">
    <thead>
      <tr>
        <th id="sortable_store_name" class="sortable<?php if ($filters['sort_by'] == 'store_name') { echo ($filters['sort_direction'] == 'desc' ? ' headerSortDown' : ' headerSortUp'); } ?>"><?php echo lang('hotcms_store')?></th>
        <th id="sortable_store_num" class="sortable<?php if ($filters['sort_by'] == 'store_num') { echo ($filters['sort_direction'] == 'desc' ? ' headerSortDown' : ' headerSortUp'); } ?>"><?php echo lang('hotcms_store_num')?></th>
    ...
    <?php foreach ($stores as $row) { ?>
      <tr id="trData_<?php echo $row->id ?>">
        ...
        <td>
          <a href="<?php printf('/hotcms/%s/store_edit/%s/%s', $module_url, $row->retailer_id, $row->id)?>"><div class="btn-edit"></div></a>
        </td>
        <td class="last">
