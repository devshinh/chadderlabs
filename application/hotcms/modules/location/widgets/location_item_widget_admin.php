...
class Location_item_widget_admin extends Widget {
  ...
  public function run( $args=array() )
  {
    ...
    $data['has_permission'] = has_permission('manage_location');
    //if (!$data['has_permission']) {
    //  return '<p>You do not have permission to manage location.</p>';
    //}
    ...
    // load widget view
    return $this->render('location_item_admin', $data);
  }
