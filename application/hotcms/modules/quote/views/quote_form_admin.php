...
<form method="post" id="formQuoteConfig" name="formQuoteConfig" class="configform" onsubmit="return config_widget(this);">
  <fieldset>
    ...
    <table>
      ...
      <tr>
        <td><label for="quote_type_id">Select Quote Form:</label></td>
        <td><?php echo form_dropdown("form_id", $form_array, $form_id);?></td>
        <td></td>
      </tr>
      <tr>
