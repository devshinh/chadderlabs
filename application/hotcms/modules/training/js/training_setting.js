jQuery( document ).ready( function() {
  ...
  jQuery("body").delegate(".edit_variant_type_link", "click", function(){
  ...
  jQuery("body").delegate(".cancel_variant_type_link", "click", function(){
    var link = jQuery(this);
    var field_id = link.attr("href");
  ...
  jQuery("body").delegate(".save_variant_type_link", "click", function(){
  ...
  jQuery("body").delegate(".delete_variant_type_link", "click", function(){
