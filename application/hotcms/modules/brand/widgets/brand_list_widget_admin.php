...
class Brand_list_widget_admin extends Widget {
  ...
  public function run( $args=array() )
  {
    ...
    if (!has_permission('manage_brand')) {
      return '<p>You do not have permission to manage brands.</p>';
    }

    // Validation rules
    // TODO: add form validation
    //$this->form_validation->set_rules('brand_id', 'Product', 'trim|required|xss_clean');
    ...
    // load widget view
    return $this->render('widget_list_admin', $data);
  }
