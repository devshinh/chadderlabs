<div class="hero-unit" id="retailer_state_locations">
    ...
    <div class="media">
        ...
        <div class="media-body">
            <h1><?php print $retailer_detail->name?> STORE LOCATIONS</h1>
        </div>
    </div>    
...
<!--    <div class="media tableHeader">
    ...
    <div class="row-fluid tableRow">
        <div class="span4" ><a href="/store/<?php print $retailer_detail->slug?>/<?php print ($store->id);?>"><?php print ($store->store_name);?></a></div> 
