        ...
        <div class="row-fluid">
          ...
          <div class="span9 question">
            ...
            if ($q->required) {
              ...
              printf("<div class='question-sentense'><strong>%s.</strong> %s (not reuqired)</div>", $counter_true_false, $q->question);
            }
        ...
        <div class="row-fluid">
          ...
          <div class="span9 question mulitple">
            ...
            if ($q->required) {
              ...
              printf("<div class='question-sentense'><strong>%s.</strong> %s (not reuqired)</div>", $counter_multiple, $q->question);
            }
            ?>
            <div class="answers">
            <?php
