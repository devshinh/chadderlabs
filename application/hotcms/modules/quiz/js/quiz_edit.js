jQuery( document ).ready( function() {
  ...
  jQuery('.save_question_link').live("click", function(){
    ...
    var mustshow = 0;
    if (jQuery("input[name='question_mustshow_" + question_id + "']").is(":checked")){
      mustshow = 1;
    }
//    var required = 0;
...
//    }
    ...
    var postdata;
    if (question_type == 1) {
      postdata = {"question_type": question_type, "question": question, "correct_answer": correct_answer, "must_show": mustshow};
    }
