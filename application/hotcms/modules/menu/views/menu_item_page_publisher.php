<h2><a class="red_button" href="<?php printf('/hotcms/%s',$module_url) ?>/create"><?php echo lang( 'hotcms_add_new' ) ?></a></h2>
<?php
...
<form id="menu_group_edit" action="/hotcms/page/save_content_layout/<?php echo $currentMenuGroupId ?>" method="post">
	<input type="hidden" name="menu_data" id="menu_data"></input>	
</form>

 <a class="red_button" id="save_menu_layout"><?php echo lang( 'hotcms_save_changes' ) ?></a> 
 <a class="red_button" onclick="window.location.reload()"><?php echo lang( 'hotcms_reset' ); ?></a>
...
*/		
		...
		*/
		...
		jQuery('#save_menu_layout').click(function() {
			/*
