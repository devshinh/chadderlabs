...
*/
	...
	$config['tables']['meta']    = 'user_profile';

	/**
	 * Site Title, example.com
	 */
	$config['site_title']		   = "Cheddar Labs";

	/**
	 * Admin Email, admin@example.com
	 */
	$config['admin_email']		   = "support@cheddarlabs.com";
	 ...
	 * id not required.
	 **/
	$config['columns'] = array('salutation', 'first_name', 'last_name', 'screen_name', 'country_code', 'province_code',
    'retailer_id', 'store_id', 'referral_code', 'employment', 'job_title', 'hire_date', 'verified',
    'newsletter_monthly', 'newsletter_newlab', 'newsletter_newswag', 'newsletter_survey');
   ...
   */
  $config['email_verify']   = 'email_verify.tpl.php';
