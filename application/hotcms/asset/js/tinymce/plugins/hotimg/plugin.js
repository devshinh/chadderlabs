...
(function() {
	...
	tinymce.PluginManager.requireLangPack('hotimg');

	tinymce.create('tinymce.plugins.HotimgPlugin', {
		/**
		...
		init : function(ed, url) {
			...
			ed.addCommand('mceHotimg', function() {
			...
			ed.onNodeChange.add(function(ed, cm, n) {
				cm.setActive('hotimg', n.nodeName == 'IMG');
			});
		},
	...
	// Register plugin
	tinymce.PluginManager.add('hotimg', tinymce.plugins.HotimgPlugin);
})();