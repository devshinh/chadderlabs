...
?></title>
    ...
    <link rel="shortcut icon" href="/themes/<?php echo $sTheme; ?>/images/favicon-DSC.ico" type="image/x-icon" />
      ...
      <div class="navbar">
        <div class="navbar-inner">
          <div class="container">
            ...
            <?php if (!empty($user_id)) { ?>
              <a class="pull-left" id="main-logo" href="/home"><img src="/themes/<?php echo $sTheme; ?>/images/logo-diamond-supply.png" alt="Diamond Supply" title="Diamond Supply" /></a>
            <?php } else { ?>
              <a class="pull-left" id="main-logo" href="/"><img src="/themes/<?php echo $sTheme; ?>/images/logo-diamond-supply.png" alt="Diamond Supply" title="Diamond Supply"  /></a>
            <?php } ?>
            <div class="pull-right hidden-mobile">
              <?php print $sMainMenu; ?>
            </div><!--/.nav-collapse -->
