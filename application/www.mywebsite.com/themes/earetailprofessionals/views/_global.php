...
?></title>
    ...
    $bg_array = array(
      ...
      'img-CandC-w2.png',
//        'img-NFS-w1.png',
      'img-battlefield-w1.png',
      'img-fifa13-w1.png',
      'img-madden13-w1.png',
      'img-me3-w1.png',
      'img-secretworld-w1.png',
      'img-simcity-w1.png'
    );
    shuffle($bg_array);
   ...
   if ($oPage->url == 'page-not-found' || $oPage->url == null) {?>
    ...
    <style type="text/css">
      html{
        background: url('/themes/<?php echo $sTheme; ?>/images/background/<?php echo $bg_array[0]; ?>') no-repeat center 5% fixed;
      }
    </style>
    <?php } ?>
  ...
  <body>
    <div class="navbar-fixed-top" >
                  ...
                  <?php } else { ?>
                    <li><div id="user-info-wrapper" class="logout">
                        ...
                        <div id="user-controls">
                          <a href="/login">Log In</a> or <a href="http://www.cheddarlabs.com/signup?ref=2">Sign Up</a>
                        </div>
                      </div></li>
                  <?php } ?>
                </ul>                 
      ...
      <div class="navbar navbar-inverse">
        <div class="navbar-inner">
          <div class="container">
            <span class="visible-mobile pull-left"><button id="main_menu_button" class="pull-right btn btn-clear" type="button" onclick="toggleVerticalMenu(-2)"><img src="/themes/<?php echo $sTheme; ?>/images/icons/btn-EARP-menu.png" alt="Menu"></button></span>
            <?php if (!empty($user_id)) { ?>
              <a class="pull-left" id="main-logo" href="/home"><img src="/themes/<?php echo $sTheme; ?>/images/logo-eaRP-121019.png" alt="EA Retail Professionals" title="EA Retail Professionals" height="72" width="241" /></a>
            <?php } else { ?>
              <a class="pull-left" id="main-logo" href="/"><img src="/themes/<?php echo $sTheme; ?>/images/logo-eaRP-121019.png" alt="EA Retail Professionals" title="EA Retail Professionals" height="72" width="241" /></a>
            <?php } ?>
            <div class="pull-right hidden-mobile">
              <?php print $sMainMenu; ?>
            </div><!--/.nav-collapse -->
      ...
      <div class="menu-header">
        ...
        <div class="media">
          ...
          <div class="media-body">
            ...
            <?php echo number_format($user_points,0) ?> points
            <br />
            <a <?php printf('href="http://%s/profile/">%s', $sMainDomain, $user_info->screen_name);?></a><br />
          </div>
        </div>
