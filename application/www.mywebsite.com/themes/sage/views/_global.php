    ...
    <div class="navbar-fixed-top" >
      ...
      <div class="navbar navbar-inverse">
        <div class="navbar-inner">
          <div class="container-fluid">
            <?php if (!empty($user_id)) { ?>
              <a id="main-logo" href="/home"><img src="/themes/<?php echo $sTheme; ?>/images/Sage-logo.jpg" alt="Sage"  /></a>
            <?php } else { ?>
              <a id="main-logo" href="/"><img src="/themes/<?php echo $sTheme; ?>/images/Sage-logo.jpg" alt="Sage" title="Sage"  /></a>
            <?php } ?>
            <div class="pull-right">
              <?php print $sMainMenu; ?>
            </div><!--/.nav-collapse -->
