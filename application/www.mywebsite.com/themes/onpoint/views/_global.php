      ...
      <div class="navbar">
        <div class="navbar-inner">
          <div class="container">
            ...
            <?php if (!empty($user_id)) { ?>
              <a class="pull-left" id="main-logo" href="/home"><img src="/themes/<?php echo $sTheme; ?>/images/logo-cheddar-labs-header.png" alt="Logo" title="Logo" /></a>
            <?php } else { ?>
              <a class="pull-left" id="main-logo" href="/"><img src="/themes/<?php echo $sTheme; ?>/images/logo-cheddar-labs-header.png" alt="Logo" title="Logo"  /></a>
            <?php } ?>
            <div class="pull-right hidden-mobile">
              <?php print $sMainMenu; ?>
            </div><!--/.nav-collapse -->
