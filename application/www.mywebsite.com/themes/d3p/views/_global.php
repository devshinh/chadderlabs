...
?></title>
    ...
    <link rel="shortcut icon" href="/themes/<?php echo $sTheme; ?>/images/favicon-d3p.ico" type="image/x-icon" />
    <link rel="icon" href="/themes/<?php echo $sTheme; ?>/images/favicon-d3p.ico" type="image/x-icon">
...
<?php
    ...
    if (strpos($path_info, 'beyblade-evolution') !== FALSE){
        $bg_array = array(
           'BG-beyblades-w2.jpg',
        );
    } elseif((strpos($path_info, 'adventure-time-explore-the-dungeon-because-i-dont-know') !== FALSE)){
        $bg_array = array(
           'BG-adventuretime-w2.jpg',
        );
    } elseif((strpos($path_info, 'regular-show-mordecai-rigby-in-8-bit-land') !== FALSE)){
        $bg_array = array(
           'BG-regshow-w2.jpg',
           'BG-regshow-w3.jpg',
           'BG-regshow-w5.jpg'
  ...
  <?php if (get_realtime_balance($sSiteID) < -25000 && (strpos($path_info, '/labs/product') !== FALSE)){?>
      ...
      <div class="navbar">
        <div class="navbar-inner">
          <div class="container">
            ...
            <?php if (!empty($user_id)) { ?>
              <a class="pull-left" id="main-logo" href="/home"><img src="/themes/<?php echo $sTheme; ?>/images/logo-d3p.png" alt="D3P" title="D3P" /></a>
            <?php } else { ?>
              <a class="pull-left" id="main-logo" href="/"><img src="/themes/<?php echo $sTheme; ?>/images/logo-d3p.png" alt="D3P" title="D3P"  /></a>
            <?php } ?>
            <div class="pull-right hidden-mobile">
              <?php print $sMainMenu; ?>
            </div><!--/.nav-collapse -->
      ...
      <div class="menu-header">
        ...
        <div class="media">
          ...
          <div class="media-body">
            ...
            <br />
            <a class="profile-link" href="http://<?php echo $sMainDomain?>/profile">View Profile</a>
          </div>
        </div>
          <?php } ?>
      </div>
