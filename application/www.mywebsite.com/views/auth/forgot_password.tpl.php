...
<table style="width:650px">
 ...
 <td style="padding:0 20px;">
	...
	<p style="text-decoration:none;color:#bd222a;"><a style="text-decoration:none;color:#bd222a;" href="http://<?php echo $_SERVER['HTTP_HOST'].'/my-account/reset_password/'. $forgotten_password_code;?>">http://<?php echo $_SERVER['HTTP_HOST'].'/my-account/reset_password/'. $forgotten_password_code;?></a></p>
	<p>Thanks!</p>
	</td>
	</tr>
	<tr>
