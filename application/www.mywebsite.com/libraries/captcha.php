  ...
  */
  function create_captcha($data = '', $img_path = '', $img_url = '', $font_path = '')
  {
   ...
   if ($word == '')
   {
    ...
    $border_color    = ImageColorAllocate($im, 153, 153, 153);
    $text_color      = ImageColorAllocate($im, 51, 51, 51);
    $grid_color      = imagecolorallocate($im, 109, 208, 246);
    ...
    */
    ...
    {
        $font_size = 15;
        $x = rand(10, $img_width/($length/1.2));
        $y = 0;
    }
    else
    {
    ...
    for ($i = 0; $i < strlen($word); $i++)
    {
        ...
        {
            $y = rand($img_height/3+3, $img_height-$font_size+15);
