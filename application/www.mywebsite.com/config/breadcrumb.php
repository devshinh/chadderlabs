 ...
 */
$config['replacer'] = array('about-speakout'=>'About SpeakOut','speakout-slingshot'=>'SpeakOut SlingShot','speakout-eclipse'=>'SpeakOut ECLIPSE');
...
$config['wrapper'] = '<ul id="crumbs" style="list-style-type:none;padding:0 5px 0 0;margin:0;">|</ul>';
$config['wrapper_inline'] = '<li style="list-style-type:none;padding:0 5px 0 0;margin:0;">|</li>';
 ...
 */
$config['strip_characters'] = array ('-', '.html', '.php', '.htm');
 ...
 */
$config['strip_regexp'] = array ('/_[a-zA-Z0-9]+/');
