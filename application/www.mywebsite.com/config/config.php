...
// the public pages will always bypass permission checks and available to all visitors
$config['public_pages'] = array('welcome', 'login', 'signup', 'register','ea-login');
// the landing page is the first page to show after a user logs in
$config['landing_page']	= 'home';

/*
 * custom configs, may put them in database
 */
//$config['site_id']	= 1;
//$config['site_domain']	= 'cheddarlabs.com';
//$config['site_name']	= 'CheddarLabs';
//$config['site_ga']	= '';
...
|
*/
$config['encryption_key'] = 'h0t0m4l1h0tCMS';
