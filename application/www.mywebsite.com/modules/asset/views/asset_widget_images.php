...
jQuery( document ).ready( function() {
  ...
  jQuery(".asset_thumb img").live("click",function(){
    ...
    if (jQuery("#preview_image").length > 0) {
      jQuery("#preview_image").html(jQuery(this).parents("tr.image_row").children(".medium_thumb").html());
    }
    if (jQuery("#image_title").length > 0) {
      jQuery("#image_title").html(jQuery(this).parents("tr.image_row").children("td.title_td").children("input").val());
    }
  });
});
</script>