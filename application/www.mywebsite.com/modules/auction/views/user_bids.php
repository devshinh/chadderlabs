...
<ul id="UserBidList">
  <li>
    <div class="itemname left"><b>Item</b></div>
    <div class="datefield left"><b>Date & Time</b></div>
    <div class="amount left"><b>Bid</b></div>
</li>
...
?>
  <li>
    ...
    <div class="amount left">$<?php echo number_format($bid->amount, 0, '.', ',') ?></div>
</li>
<?php
  }
?>
