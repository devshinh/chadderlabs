...
<table style="width:650px">
 <tr>
  <td style="border-bottom: 3px solid #D4D5D7;">
 ...
 <td style="padding:0 20px;">
	...
	<p>Thanks!<br/>Hot Tomali & MWCT</p>
	</td>
	</tr>
	<tr>
	<td style="border-top: 3px solid #D4D5D7;text-align:right">
  <div id="footer">
   <p>Copyright &copy; <?php echo date('Y') ?>&nbsp;&nbsp; <a _target="_blank" href="http://www.hottomali.com"><img style="width:45px;height:22px;vertical-align:middle" alt="HotTomali Logo" src="http://<?php echo $_SERVER['HTTP_HOST']?>/themes/auction/images/htc_logo.jpg" /></a></p>
  </div>	 
	 </td>
	</tr>
</table>
