...
<div class="container-fluid quiz" id="quiz-<?php print($item->id); ?>">
    ...
    <div class="row-fluid">
        ...
        <div class="span8">
            ...
            <?php if (isset($sphero_badge) && $sphero_badge) { ?>
                <div class="row-fluid">
                    <div class="span2">
                        <?php print($sphero_badge_icon->badge_icon->thumb_html) ?>
                    </div>
                    <div class="span10">
                        <p>Congratulations! You earned the Sphero Expert Badge. Check your email inbox for a certificate of completion and a special discount on Sphero products.</p>
                    </div>
                </div>
                <br />
            <?php } ?>

            <?php if (isset($genius_badge) && $genius_badge) { ?>
                <div class="row-fluid">
                    <div class="span2">
                        <?php print($genius_badge_icon->badge_icon->thumb_html) ?>
                    </div>
                    <div class="span10">
                        <p>Congratulations! You got the Genius Badge.</p>
                    </div>
                </div>
                <br />
<?php } ?>      
...
<?php } ?>
            <!-- draws -->
            <?php if (has_permission('earn_draws')) { ?>    
                <div class="row-fluid">
                    <div class="item-subtitle">Contest Entries Achieved: <span class="blue"> <?php print($history->draw_entry) ?></span></div>
                </div> 
<?php } ?>
            <p style="padding-right: 50px;padding-top: 15px;">
                <a class="btn btn-primary" href="/labs/product/<?php echo $training->slug; ?>">Back to training</a>
            </p>      
        </div>
    </div>
...
<!-- modal for badges -->
    ...
    <?php if ($sphero_badge || $genius_badge) { ?>

    <div id="badge-modal" class="modal hide fade in" style="display: none; ">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h4 class="modal-title">CheddarLabs Badges</h4>
          </div>
    ...
    <?php if (isset($sphero_badge) && $sphero_badge) { ?>
        ...
        <?php print($sphero_badge_icon->badge_icon->thumb_html) ?>
                    ...
                    <div class="span10">
                        <p>Congratulations! You earned the Sphero Expert Badge - Check your inbox for a special discount!</p>
                    </div>
                </div>
                    <?php } ?>  
       <?php if (isset($genius_badge) && $genius_badge) { ?>
