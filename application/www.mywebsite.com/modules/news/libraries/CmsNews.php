...
class CmsNews {
  ...
  public function save($attr = array()) {
    ...
    if (array_key_exists('status', $attr)) {
      ...
      $status_changed = $new_status != $this->status;
  ...
  public static function random_slug() {
   ...
   /**
   * Get a slug(s) for widgets
   */
  public static function random_preview_slug($type, $training_item_id = 0) {
    $CI =& get_instance();
    return $CI->news_model->get_preview_slug($type, $training_item_id);
  }
