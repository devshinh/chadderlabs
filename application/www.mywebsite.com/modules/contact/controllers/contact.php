...
*/
 ...
 public function validate($item_id) {
    $this->form_validation->set_rules( 'email_'.$item_id, strtolower(lang( 'hotcms_email_address' )), 'trim|filter_var|required' );
 }
...
*/
  ...
  private function set_edit_form_contact($current_item)
 {
  ...
  public function add_contact_from_shipping(){
              $user_id = $this->input->post('user_id');
              $contact_name = $this->input->post('contact_name');
              if(!empty($contact_name)){
                $this->model_contact->insert_from_shipping($user_id, 'user',$contact_name);
                redirect('/shop/shipping');
              }else{
                  redirect('/shop/shipping?error');
              }
  }
